...
public:
    static const std::string angle_name_short;
    static const std::string step_size_name_short;
    static const std::string iteration_name_short;
    static const std::string grammar_name_short;
private:

    fpreal  ANGLE(fpreal t) { return evalFloat(angle_name_short, 0, t); };
    fpreal  STEP_SIZE(fpreal t) { return evalFloat(step_size_name_short, 0, t); };
    fpreal  ITERATION(fpreal t) { return evalInt(iteration_name_short, 0, t); };
    void GRAMMAR_FILE(UT_String& s, fpreal t) { evalString(s, grammar_name_short, 0, t); }
